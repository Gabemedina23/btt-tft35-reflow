...
static const ReflowProfile profileLeaded = {
  ...
  .stages = {
    ...
    { .name = "Soak",    .targetTemp = 183.0f, .rampRate =  0.7f, .holdTime = 60, .heaterCutoff = 0      },
    { .name = "Reflow",  .targetTemp = 230.0f, .rampRate =  2.0f, .holdTime = 0,  .heaterCutoff = 225.0f },
    { .name = "Peak",    .targetTemp = 230.0f, .rampRate =  0.0f, .holdTime = 15, .heaterCutoff = 0      },
...
static const ReflowProfile profileLeadFree = {
  ...
  .stages = {
    { .name = "Preheat", .targetTemp = 150.0f, .rampRate =  2.0f, .holdTime = 0,  .heaterCutoff = 140.0f },
    { .name = "Soak",    .targetTemp = 217.0f, .rampRate =  0.7f, .holdTime = 90, .heaterCutoff = 0      },
    { .name = "Reflow",  .targetTemp = 240.0f, .rampRate =  2.0f, .holdTime = 0,  .heaterCutoff = 235.0f },
    { .name = "Peak",    .targetTemp = 240.0f, .rampRate =  0.0f, .holdTime = 20, .heaterCutoff = 0      },
    { .name = "Cool",    .targetTemp =  50.0f, .rampRate = -3.0f, .holdTime = 0,  .heaterCutoff = 0      },
  },
  .pidKp = 0.69f,
  .pidKi = 0.0028f,
